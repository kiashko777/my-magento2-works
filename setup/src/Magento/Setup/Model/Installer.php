...
class Installer
{
     ...
     */
    const SCHEMA_INSTALL = InstallSchemaInterface::class;
    const SCHEMA_UPGRADE = UpgradeSchemaInterface::class;
    const DATA_INSTALL = InstallDataInterface::class;
    const DATA_UPGRADE = UpgradeDataInterface::class;
    /**#@- */
    ...
    private function handleDBSchemaData($setup, $type, array $request)
    {
        ...
        $resource = new ModuleResource($this->context);
