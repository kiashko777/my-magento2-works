...
use Devall\Customform\Api\CustomformRepositoryInterface;
use Devall\Customform\Api\Data\CustomformInterfaceFactory;
use Devall\Customform\Api\Data\CustomformSearchResultsInterfaceFactory;
use Devall\Customform\Model\ResourceModel\Customform as ResourceCustomform;
use Devall\Customform\Model\ResourceModel\Customform\CollectionFactory as CustomformCollectionFactory;
...
class CustomformRepository implements CustomformRepositoryInterface
{
    ...
    )
    {
        ...
        $customformData = $this->extensibleDataObjectConverter->toNestedArray(
            $customform,
            [],
            \Devall\Customform\Api\Data\CustomformInterface::class
        );
