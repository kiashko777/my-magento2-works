...
class OrderGetTest extends WebapiAbstract
{
    ...
    public function testGetOrderWithProductOption(): void
    {
        ...
        self::assertNotEmpty($bundleProduct, '"Bundle Products" should not be empty.');
        self::assertNotEmpty($bundleProduct['product_option'], '"Products Option" should not be empty.');
