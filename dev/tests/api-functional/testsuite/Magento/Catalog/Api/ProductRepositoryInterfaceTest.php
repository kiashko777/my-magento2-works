...
class ProductRepositoryInterfaceTest extends WebapiAbstract
{
    ...
    private $productData = [
        [
            ...
            ProductInterface::NAME => 'Simple Related Products',
            ProductInterface::TYPE_ID => 'simple',
            ProductInterface::PRICE => 10,
        ],
        [
            ProductInterface::SKU => 'simple_with_cross',
            ProductInterface::NAME => 'Simple Products With Related Products',
            ProductInterface::TYPE_ID => 'simple',
            ProductInterface::PRICE => 10,
        ],
    ];
    ...
    public function testProductLinks()
    {
        ...
        $productWithRelatedData = [
            ...
            ProductInterface::NAME => "Products Simple with Related 500",
            ProductInterface::VISIBILITY => 4,
            ProductInterface::TYPE_ID => 'simple',
            ProductInterface::PRICE => 100,
            ProductInterface::STATUS => 1,
    ...
    {
        $productData = [
            ProductInterface::NAME => 'Very Simple Products', //new name
    ...
    public function testUpdateStatus()
    {
        ...
        $productData = [
            ...
            ProductInterface::NAME => "Products Simple 502",
            ProductInterface::VISIBILITY => 4,
            ProductInterface::TYPE_ID => 'simple',
            ProductInterface::PRICE => 100,
