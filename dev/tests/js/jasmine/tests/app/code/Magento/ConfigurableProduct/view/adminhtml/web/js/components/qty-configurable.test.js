...
define(['squire'], function (Squire) {
    ...
    describe('Magento_ConfigurableProduct/js/components/qty-configurable', function () {
        it('Products is not configurable by default', function () {
        ...
        it('Products changed to configurable', function () {
            var component = new Component(params);
        ...
        it('Products is configurable by default', function () {
        ...
        it('Products changed from configurable to another one', function () {
            var component = new Component($.extend({}, params, {
                // eslint-disable-next-line max-nested-callbacks
                setLinks: jasmine.createSpy().and.callFake(function () {
                    this.isConfigurable = true;
