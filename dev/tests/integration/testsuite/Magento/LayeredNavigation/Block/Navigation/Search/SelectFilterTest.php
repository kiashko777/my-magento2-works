...
use Magento\LayeredNavigation\Block\Navigation\Category\SelectFilterTest as CategorySelectFilterTest;

/**
 * Provides tests for custom select filter in navigation block on search page.
 *
