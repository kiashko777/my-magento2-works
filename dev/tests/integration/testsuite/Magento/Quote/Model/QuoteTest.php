...
//        $this->expectExceptionMessage('The requested qty is not available');
    ...
    public function testAddedProductToQuoteIsSalable(): void
    {
        ...
        $this->expectException(LocalizedException::class);
        $this->expectExceptionMessage((string)__('Products that you are trying to add is not available.'));
    ...
    public function testAddProductOutOfStock(): void
    {
        ...
        $this->expectExceptionObject(
            new LocalizedException(__('Products that you are trying to add is not available.'))
        );
