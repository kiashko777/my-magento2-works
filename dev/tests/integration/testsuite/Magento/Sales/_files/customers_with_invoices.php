...
$order2->setState(Order::STATE_NEW);
$order2->setStatus($order->getConfig()->getStateDefaultStatus(Order::STATE_NEW));
...
$order2->setStoreId($objectManager->get(StoreManagerInterface::class)->getStore()->getId());
