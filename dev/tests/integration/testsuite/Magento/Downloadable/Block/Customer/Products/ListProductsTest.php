...
class ListProductsTest extends TestCase
{
    ...
    public function testPendingOrder(): void
    {
        ...
        $this->assertEquals(
            ...
            Xpath::getElementsCountForXpath(
                sprintf($this->downloadLinkXpath, 'Downloadable Products link'),
    ...
    public function testCompleteOrder(): void
    {
        ...
        $this->assertEquals(
            1,
            Xpath::getElementsCountForXpath(sprintf($this->downloadLinkXpath, 'Downloadable Products link'), $html),
