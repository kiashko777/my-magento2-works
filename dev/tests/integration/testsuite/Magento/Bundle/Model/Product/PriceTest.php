...
class PriceTest extends TestCase
{
    ...
    /**
     * Fixed Bundle Products with catalog price rule
    ...
    /**
     * Fixed Bundle Products without discounts
     * @magentoDataFixture Magento/Bundle/_files/fixed_bundle_product_without_discounts.php
     *
     * @return void
     */
    ...
    /**
     * Fixed Bundle Products with special price
    ...
    /**
     * Fixed Bundle Products with tier price
    ...
    /**
     * Dynamic Bundle Products without discount + options without discounts
    ...
    /**
     * Dynamic Bundle Products without discount + options with special price
     * @magentoDataFixture Magento/Bundle/_files/dynamic_bundle_product_without_discounts.php
     *
     * @return void
     */
    ...
    /**
     * Dynamic Bundle Products without discount + options with tier prices
     * @magentoDataFixture Magento/Bundle/_files/dynamic_bundle_product_without_discounts.php
     *
     * @return void
     */
    ...
    /**
     * Dynamic Bundle Products without discounts + options with catalog rule
     * @magentoDataFixture Magento/Bundle/_files/dynamic_bundle_product_without_discounts.php
    ...
    /**
     * Dynamic Bundle Products with tier price + options without discounts
    ...
    /**
     * Dynamic Bundle Products with tier price + options with special prices
     * @magentoDataFixture Magento/Bundle/_files/dynamic_bundle_product_with_tier_price.php
     *
     * @return void
     */
    ...
    /**
     * Dynamic Bundle Products with tier price + options with tier price
     * @magentoDataFixture Magento/Bundle/_files/dynamic_bundle_product_with_tier_price.php
     *
     * @return void
     */
    ...
    /**
     * Dynamic Bundle Products with tier price + options with catalog rule
     * @magentoDataFixture Magento/Bundle/_files/dynamic_bundle_product_with_tier_price.php
     * @magentoDataFixture Magento/CatalogRule/_files/catalog_rule_for_category_999.php
     *
     * @return void
    ...
    /**
     * Dynamic Bundle Products with special price + options without discounts
    ...
    /**
     * Dynamic Bundle Products with special price + options with special prices
     * @magentoDataFixture Magento/Bundle/_files/dynamic_bundle_product_with_special_price.php
     *
     * @return void
     */
    ...
    /**
     * Dynamic Bundle Products with special price + options with tier prices
     * @magentoDataFixture Magento/Bundle/_files/dynamic_bundle_product_with_special_price.php
     *
     * @return void
     */
    ...
    /**
     * Dynamic Bundle Products with special price + options with catalog price rule
     * @magentoDataFixture Magento/Bundle/_files/dynamic_bundle_product_with_special_price.php
     * @magentoDataFixture Magento/CatalogRule/_files/catalog_rule_for_category_999.php
     *
     * @return void
    ...
    /**
     * Dynamic Bundle Products with catalog price rule + options without discounts
    ...
    /**
     * Dynamic Bundle Products with catalog price rule + options with catalog price rule
     * @magentoDataFixture Magento/Bundle/_files/dynamic_bundle_product_with_catalog_rule.php
     * @magentoDataFixture Magento/CatalogRule/_files/catalog_rule_for_category_999.php
     *
     * @return void
    ...
    /**
     * Dynamic Bundle Products with catalog price rule + options with special prices
     * @magentoDataFixture Magento/Bundle/_files/dynamic_bundle_product_with_catalog_rule.php
     *
     * @return void
     */
    ...
    /**
     * Dynamic Bundle Products with catalog price rule + options with tier price
     * @magentoDataFixture Magento/Bundle/_files/dynamic_bundle_product_with_catalog_rule.php
     *
     * @return void
     */
