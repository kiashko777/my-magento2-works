...
$product->setTypeId(\Magento\Catalog\Model\Product\Type::TYPE_SIMPLE)
    ...
    ->setPrice(22)
    ->setWeight(3)
    ->setShortDescription("Blue or green shorts for all peoples at one")
    ->setTaxClassId(0)
    ->setTierPrice(
        [
            [
    ...
    ->setDescription('Blue or green shorts for peoples at <b>one</b>')
    ->setMetaTitle('blue shorts meta title')
    ->setMetaKeyword('blue,shorts,meta,men')
    ->setMetaDescription('blue shorts meta description')
    ->setVisibility(Visibility::VISIBILITY_BOTH)
    ->setStatus(Status::STATUS_ENABLED)
    ->setCategoryIds([2])
    ->setStockData(
...
$product->setTypeId(\Magento\Catalog\Model\Product\Type::TYPE_SIMPLE)
    ...
    ->setPrice(24)
    ->setWeight(3)
    ->setShortDescription("Red or green shorts for all peoples at one")
    ->setTaxClassId(0)
    ->setTierPrice(
        [
            [
    ...
    ->setDescription('Red or green shorts for peoples at <b>one</b>')
    ->setMetaTitle('red shorts meta title')
    ->setMetaKeyword('red,shorts,meta,men')
    ->setMetaDescription('red shorts meta description')
    ->setVisibility(Visibility::VISIBILITY_BOTH)
    ->setStatus(Status::STATUS_ENABLED)
    ->setCategoryIds([2])
    ->setStockData(
...
$product->setTypeId(\Magento\Catalog\Model\Product\Type::TYPE_SIMPLE)
    ...
    ->setAttributeSetId(4)
    ->setWebsiteIds([1])
    ->setName('Yellow shorts')
    ->setSku('yellow_shorts')
    ->setPrice(26)
    ->setWeight(3)
    ->setShortDescription("Yellow or green shorts for all peoples at one")
    ->setTaxClassId(0)
    ->setTierPrice(
        [
            [
    ...
    ->setDescription('Yellow or green shorts for peoples at <b>one</b>')
    ->setMetaTitle('yellow shorts meta title')
    ->setMetaKeyword('yellow,shorts,meta,men')
    ->setMetaDescription('yellow shorts meta description')
    ->setVisibility(Visibility::VISIBILITY_BOTH)
    ->setStatus(Status::STATUS_ENABLED)
    ->setCategoryIds([2])
    ->setStockData(
