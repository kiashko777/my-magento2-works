...
$product1 = $productRepository->get('Simple Products 1 sku');
$product2 = $productRepository->get('Simple Products 2 sku');
$product3 = $productRepository->get('Simple Products 3 sku');
$product4 = $productRepository->get('Simple Products 4 sku');
