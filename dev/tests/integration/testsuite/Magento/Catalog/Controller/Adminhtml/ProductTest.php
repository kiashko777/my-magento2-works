...
class ProductTest extends AbstractBackendController
{
    ...
    /**
     * Testing Add Products button showing.
     */
    public function testIndexAction()
    {
        ...
        $this->assertEquals(
            ...
            '"Add Products" button container should be present on Manage Products page, if the limit is not  reached'
        );
        $this->assertEquals(
            1,
            \Magento\TestFramework\Helper\Xpath::getElementsCountForXpath(
            ...
            '"Add Products" button should be present on Manage Products page, if the limit is not reached'
        );
        $this->assertEquals(
            0,
            \Magento\TestFramework\Helper\Xpath::getElementsCountForXpath(
            ...
            '"Add Products" button should be enabled on Manage Products page, if the limit is not reached'
        );
        $this->assertEquals(
            1,
            \Magento\TestFramework\Helper\Xpath::getElementsCountForXpath(
            ...
            '"Add Products" button split should be present on Manage Products page, if the limit is not reached'
        );
    }
    ...
    public function testEditAction()
    {
        ...
        $this->assertEquals(
            ...
            '"Save" button isn\'t present on Edit Products page'
        );
        ...
        $this->assertEquals(
            ...
            '"Save & New" button isn\'t present on Edit Products page'
        );
        ...
        $this->assertEquals(
            ...
            '"Save & Duplicate" button isn\'t present on Edit Products page'
        );
    }
