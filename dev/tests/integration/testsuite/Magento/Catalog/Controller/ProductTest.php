...
class ProductTest extends AbstractController
{
    ...
    public function testViewAction(): void
    {
        ...
        /* Meta info */
        $this->assertStringContainsString('<title>Simple Products 1 Meta Title</title>', $responseBody);
        $this->assertEquals(
            1,
            Xpath::getElementsCountForXpath(
                '//meta[@name="keywords" and @content="Simple Products 1 Meta Keyword"]',
                $responseBody
            )
        );
        $this->assertEquals(
            1,
            Xpath::getElementsCountForXpath(
                '//meta[@name="description" and @content="Simple Products 1 Meta Description"]',
                $responseBody
            )
        );
    }
