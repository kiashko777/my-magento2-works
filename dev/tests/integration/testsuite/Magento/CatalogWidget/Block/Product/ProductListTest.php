...
class ProductListTest extends TestCase
{
    ...
    public function testCreateCollection()
    {
        ...
        $encodedConditions = '^[`1`:^[`type`:`Magento||CatalogWidget||Model||Rule||Condition||Combine`,'
            ...
            . '^[`type`:`Magento||CatalogWidget||Model||Rule||Condition||Products`,'
        ...
        $this->assertEquals(
            ...
            "Products collection was not filtered according to the widget condition."
        );
    }
    ...
    public function testCreateCollectionWithDropdownAttribute()
    {
        ...
        $encodedConditions = '^[`1`:^[`type`:`Magento||CatalogWidget||Model||Rule||Condition||Combine`,' .
            ...
            '|Condition||Products`,`attribute`:`dropdown_attribute`,`operator`:`==`,`value`:`'
