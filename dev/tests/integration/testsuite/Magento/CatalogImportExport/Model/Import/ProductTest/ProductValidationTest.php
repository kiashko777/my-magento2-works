...
class ProductValidationTest extends ProductTestBase
{
    ...
    public function testInvalidSkuLink()
    {
        ...
        $this->assertArrayNotHasKey("simple1", $products, "Simple Products should not have been imported");
        $this->assertArrayNotHasKey("simple3", $products, "Simple Products 3 should not have been imported");
