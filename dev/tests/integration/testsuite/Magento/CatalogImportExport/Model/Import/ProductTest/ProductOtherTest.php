...
class ProductOtherTest extends ProductTestBase
{
    ...
    public function testSaveProductsVisibility()
    {
        ...
        foreach ($productsBeforeImport as $productBeforeImport) {
            ...
            $productAfterImport = Bootstrap::getObjectManager()->create(
                Product::class
            );
    ...
    public function testImportDataChangeAttributeSet()
    {
        ...
        $products[] = Bootstrap::getObjectManager()
            ->create(ProductRepository::class)->get('simple');
        $products[] = Bootstrap::getObjectManager()
            ->create(ProductRepository::class)->get('simple2');

        /** @var \Magento\Catalog\Model\Config $catalogConfig */
        $catalogConfig = Bootstrap::getObjectManager()
            ->create(\Magento\Catalog\Model\Config::class);

        /** @var Config $eavConfig */
        $eavConfig = Bootstrap::getObjectManager()
            ->create(Config::class);
