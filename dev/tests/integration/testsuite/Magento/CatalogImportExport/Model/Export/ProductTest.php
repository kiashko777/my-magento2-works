...
class ProductTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testExport(): void
    {
        ...
        $this->assertStringContainsString('New Products', $exportData);
    ...
    public function testCategoryIdsFilter(): void
    {
        ...
        $this->assertStringContainsString('Simple Products', $exportData);
        $this->assertStringContainsString('Simple Products Three', $exportData);
        $this->assertStringNotContainsString('Simple Products Two', $exportData);
        $this->assertStringNotContainsString('Simple Products Not Visible On Storefront', $exportData);
    }
    ...
    public function filterByQuantityAndStockStatusDataProvider(): array
    {
        return [
            [
                ...
                [
                    'Simple Products OOS',
                    'Simple Products Not Visible',
                    'Simple Products Visible and InStock',
                ],
                [
                ],
            ],
    ...
    /**
     * Test that Products Export takes into account filtering by Website
     *
