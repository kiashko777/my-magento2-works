...
class TokenTest extends TestCase
{
    ...
    /**
     * Make sure that @param int $secondsAfterBaseCreatedTimestamp
     ...
     * @see          \Magento\Integration\Cron\CleanExpiredTokens cleans tokens correctly per configuration
     *
    ...
    {
        /** @var CleanExpiredTokens $cleanExpiredTokensModel */
    ...
    /**
     * Verify that expired tokens removal works as expected, @param $secondsAfterBaseCreatedTimestamp
     ...
     * @see          \Magento\Integration\Model\ResourceModel\Oauth\Token
     *
     * 1. Generate several tokens with different user type and creation time
     * 2. Emulate current time stamp to be equal to (expiration period + some adjustment)
    ...
    protected function setUp(): void
    {
        ...
        $this->tokenFactory = $this->objectManager->create(TokenFactory::class);
    ...
    private function generateTokens()
    {
        ...
        /** @var DateTime $dateTimeUtils */
        $dateTimeUtils = $this->objectManager->get(DateTime::class);
