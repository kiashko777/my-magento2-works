            ...
            $.jstree.plugin("vcheckbox", {
                ...
                _fn: {
                    ...
                    _prepare_checkboxes: function (obj) {
                        ...
                        var c, _this = this, t, ts = this._get_settings().vcheckbox.two_state,
                            rc = this._get_settings().vcheckbox.real_checkboxes,
                            rcn = this._get_settings().vcheckbox.real_checkboxes_names;
                        obj.each(function () {
                            t = $(this);
                            c = t.is("li") && (t.hasClass("jstree-checked") || (rc && t.children(":checked").length)) ? "jstree-checked" : "jstree-unchecked";
                            t.find("li").addBack().each(function () {
                    ...
                    change_state: function (obj, state) {
                        ...
                        if (this._get_settings().vcheckbox.two_state) {
                            if (state) {
                                coll = obj.find("li").addBack();
                                if (!coll.filter(".jstree-checked").length) {
                                    return false;
                                }
                                ...
                                coll = obj.find("li").addBack();
                                if (!coll.filter(".jstree-unchecked").length) {
                                    return false;
                                }
                            ...
                            obj.parentsUntil(".jstree", "li").each(function () {
                                ...
                                if (state) {
                                    if ($this.children("ul").children("li.jstree-checked").length) {
                                        ...
                                        if (rc) {
                                            $this.parentsUntil(".jstree", "li").addBack().children(":checkbox").prop("checked", true);
                                        }
                                        return false;
                                    }
                                } else {
