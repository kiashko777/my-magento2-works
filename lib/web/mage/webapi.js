...
define([
    ...
    $.mage.Webapi = function (baseUrl, ajaxArgs) {
        ...
        /**
         * Resource-related parameters. Further extended by other domain objects like Products, etc.
         *
         * @const
         * @type {Object}
         */
    ...
    /**
     * Syntax sugar over call(). Example usage: $.mage.webapi.Products('v1').get({...})
     *
